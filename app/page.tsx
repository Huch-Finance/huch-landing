        ...
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between">
          ...
          <div className="bg-zinc-900/80 backdrop-blur-sm rounded-full border border-zinc-800/50 px-6 py-2.5 hidden md:flex items-center">
            <div className="flex items-center gap-8">
              <a
                href="https://discord.gg/K3WTREYv" target="_blank" rel="noopener noreferrer"
              ...
              <div className="flex flex-col items-center text-center max-w-md mx-auto">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex space-x-4 justify-center">
                    <a href="https://discord.gg/K3WTREYv" target="_blank" className="text-zinc-400 hover:text-white transition-colors">
                      <svg
                        className="w-5 h-5"
                        viewBox="0 0 24 24"
                        fill="currentColor"
